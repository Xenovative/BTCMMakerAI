...
export const config = {
  ...
  AI_MIN_SCORE: Number(process.env.AI_MIN_SCORE) || 0, // 最低綜合評分門檻（更寬鬆）
  AI_MIN_CONFIDENCE: Number(process.env.AI_MIN_CONFIDENCE) || 20, // 最低信心度門檻 (%)
  AI_MIN_POSITION_SIZE: Number(process.env.AI_MIN_POSITION_SIZE) || 1, // AI 模式下最小倉位
