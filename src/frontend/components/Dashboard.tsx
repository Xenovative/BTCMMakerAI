                    ...
                    <div>
                      ...
                      <div className={pos.unrealizedPnl >= 0 ? 'text-green-400' : 'text-red-400'}>
                        ...
                        <span className="ml-2 text-xs text-gray-400">
                          ({pos.returnPct != null ? (pos.returnPct * 100).toFixed(2) : pos.avgBuyPrice > 0 ? (((pos.currentPrice - pos.avgBuyPrice) / pos.avgBuyPrice) * 100).toFixed(2) : '—'}% | ${pos.returnUsd != null ? pos.returnUsd.toFixed(2) : ((pos.currentPrice - pos.avgBuyPrice) * pos.size / 100).toFixed(2)})
                        </span>
                      </div>
                    </div>
                  </div>
